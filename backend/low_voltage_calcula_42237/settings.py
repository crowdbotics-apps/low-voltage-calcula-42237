"""
Django settings for low_voltage_calcula_42237 project.
...
ROOT_URLCONF = 'low_voltage_calcula_42237.urls'
...
WSGI_APPLICATION = 'low_voltage_calcula_42237.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "low_voltage_calcula_42237 API",
    "DESCRIPTION": "API documentation for low_voltage_calcula_42237 App",
    "VERSION": "v1",
}
