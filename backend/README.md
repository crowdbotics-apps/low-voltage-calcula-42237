...
## Project Structure
    ...
    ├── low_voltage_calcula_42237  # Django project configurations
...
1. Clone this repo and `cd low_voltage_calcula_42237`
...
2. Clone this repo and `cd low_voltage_calcula_42237`
